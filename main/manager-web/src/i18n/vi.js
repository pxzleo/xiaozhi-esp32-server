export default {
  ...
  'device.displayNameInvalid': 'Tên hiển thị là bắt buộc và tối đa 64 ký tự',
  'device.displayNameSaved': 'Đã lưu tên hiển thị',
  'device.displayNameSaveFailed': 'Không thể lưu tên hiển thị',
  'terminalSensing.title': 'Thiết bị và cảm nhận',
  ...
  'agentSnapshot.plugin.SYSTEM_PLUGIN_NETEASE_MUSIC': 'Trình phát NetEase Cloud Music',
  ...
  'functionDialog.neteaseLoginStatus': 'Tài khoản NetEase Cloud',
  'functionDialog.neteaseLoggedIn': 'Đã đăng nhập',
  'functionDialog.neteaseAnonymous': 'Chưa đăng nhập; chỉ phát nhạc công khai miễn phí',
  'functionDialog.neteaseWaitingScan': 'Đang chờ xác nhận mã QR',
  'functionDialog.neteaseQrExpired': 'Mã QR đã hết hạn',
  'functionDialog.neteaseScanLogin': 'Quét mã để đăng nhập',
  'functionDialog.neteaseLogout': 'Xóa đăng nhập',
  'functionDialog.neteaseQrAlt': 'Mã QR đăng nhập NetEase Cloud Music',
  'functionDialog.neteaseLoginTip': 'Sau khi đăng nhập, lệnh thoại có thể phát danh sách nhạc, đề xuất hằng ngày, Personal FM và bài VIP thuộc quyền lợi tài khoản. Thông tin đăng nhập không được hiển thị.',
  'functionDialog.neteaseLoginSuccess': 'Đăng nhập NetEase Cloud Music thành công. Hãy lưu cấu hình.',
  'functionDialog.neteaseLoginFailed': 'Đăng nhập NetEase Cloud Music thất bại',
  'functionDialog.neteaseLogoutSuccess': 'Đã xóa đăng nhập NetEase Cloud Music',
  ...
  'proactive.title': 'Trợ lý chủ động',
  'proactive.routing.title': 'Thiết bị nhận',
  'proactive.routing.introTitle': 'Phân phối hành động chủ động theo địa điểm',
  'proactive.routing.introHelp': 'Lời nhắc, báo thức và cuộc trò chuyện chủ động mặc định được gửi tới các thiết bị đã chọn. Khi nhận diện địa điểm, danh sách nhận tại đó sẽ được dùng.',
  'proactive.routing.futureOnly': 'Thay đổi đã lưu chỉ áp dụng cho sự kiện mới, không gửi lại hoặc thay đổi sự kiện hiện có.',
  'proactive.routing.defaults': 'Thiết bị nhận mặc định',
  'proactive.routing.defaultsHelp': 'Dùng khi vị trí không xác định, đã hết hạn hoặc không có quy tắc. Mặc định chọn mọi thiết bị trong tài khoản.',
  'proactive.routing.selectAll': 'Chọn tất cả',
  'proactive.routing.clearAll': 'Bỏ chọn tất cả',
  'proactive.routing.noDevices': 'Tài khoản này không có thiết bị khả dụng.',
  'proactive.routing.emptyDefaultsHelp': 'Nếu không có thiết bị nhận mặc định, hành động chủ động sẽ không được gửi khi vị trí không xác định hoặc hết hạn.',
  'proactive.routing.places': 'Quy tắc nhận theo địa điểm',
  'proactive.routing.placesHelp': 'Địa điểm đến từ vùng địa lý được tạo và báo cáo bởi ứng dụng di động. Mỗi địa điểm có thể có nhiều thiết bị nhận.',
  'proactive.routing.activePlace': 'Địa điểm hiện tại hợp lệ',
  'proactive.routing.noPlaces': 'Chưa có địa điểm. Hãy tạo địa điểm trong ứng dụng di động và hoàn tất một lần báo vị trí.',
  'proactive.routing.chooseDevices': 'Chọn thiết bị nhận',
  'proactive.routing.locationDoesNotNotify': 'Địa điểm chỉ dùng để chọn thiết bị nhận. Việc vào hoặc rời địa điểm không tự kích hoạt thông báo chủ động.',
  'proactive.routing.locationAuthority': 'Điện thoại xác định vị trí',
  'proactive.routing.locationAuthorityHelp': 'Khi có nhiều điện thoại, chỉ thiết bị này xác định vị trí. Nếu chưa chọn hoặc quá 12 giờ, dùng thiết bị mặc định. Chỉ áp dụng sự kiện mới.',
  'proactive.routing.noLocationAuthority': 'Chưa chỉ định',
  'proactive.routing.fixedDevices': 'Địa điểm của thiết bị cố định',
  'proactive.routing.fixedDevicesHelp': 'Đánh dấu vị trí của thiết bị cố định như loa để dễ quản lý quy tắc địa điểm.',
  'proactive.routing.noFixedPlace': 'Không có địa điểm cố định',
  'proactive.routing.save': 'Lưu thiết bị nhận',
  'proactive.routing.loadFailed': 'Không thể tải cài đặt thiết bị nhận',
  'proactive.routing.saveFailed': 'Không thể lưu cài đặt thiết bị nhận. Hãy làm mới và thử lại.',
  'proactive.routing.saveSuccess': 'Đã lưu cài đặt thiết bị nhận',
  'proactive.routing.terminalType.mobile': 'Điện thoại',
  'proactive.routing.terminalType.speaker': 'Loa',
  'proactive.routing.validation.devices': 'Lựa chọn thiết bị không hợp lệ. Hãy làm mới và thử lại.',
  'proactive.routing.validation.places': 'Cài đặt địa điểm không hợp lệ. Hãy làm mới và thử lại.',
  'proactive.routing.validation.version': 'Phiên bản cài đặt không hợp lệ. Hãy làm mới và thử lại.',
  ...
  'proactive.settings': 'Cài đặt',
  'proactive.events': 'Nhật ký sự kiện',
  'proactive.mobileEvents': 'Sự kiện cảm nhận di động',
  'proactive.mobile.type': 'Loại cảm nhận',
  'proactive.mobile.stage': 'Giai đoạn xử lý',
  'proactive.mobile.from': 'Thời gian bắt đầu',
  'proactive.mobile.to': 'Thời gian kết thúc',
  'proactive.mobile.noEvents': 'Không có sự kiện cảm nhận di động',
  'proactive.mobile.instance': 'Phiên bản di động',
  'proactive.mobile.source': 'Ứng dụng nguồn',
  'proactive.mobile.summary': 'Tóm tắt đã khử nhạy cảm',
  'proactive.mobile.spokenSummary': 'Tóm tắt đọc có kiểm soát',
  'proactive.mobile.reasonCode': 'Lý do có kiểm soát',
  'proactive.mobile.proactiveEvent': 'Sự kiện chủ động được liên kết',
  'proactive.mobile.occurredAt': 'Thời điểm xảy ra',
  'proactive.mobile.category': 'Danh mục',
  'proactive.mobile.confidence': 'Độ tin cậy',
  'proactive.mobile.instanceUnavailable': 'Thiết bị đã chọn không phải phiên bản di động đã liên kết',
  'proactive.mobile.chooseSettingsPhone': 'Chọn điện thoại để chỉnh cài đặt cảm nhận',
  'proactive.mobile.loadFailed': 'Không thể tải sự kiện cảm nhận di động',
  'proactive.mobile.sensitivity': 'Độ nhạy cảnh báo',
  'proactive.mobile.sensitivity.conservative': 'Thận trọng',
  'proactive.mobile.sensitivity.balanced': 'Cân bằng',
  'proactive.mobile.sensitivity.timely': 'Kịp thời',
  'proactive.mobile.categories': 'Phạm vi cảnh báo',
  'proactive.mobile.categoriesHelp': 'Giao hàng, bảo mật, cuộc gọi nhỡ và lịch hẹn dùng quy tắc xác định; nội dung khác được mô hình đánh giá.',
  'proactive.mobile.category.security': 'Bảo mật tài khoản',
  'proactive.mobile.category.call': 'Cuộc gọi nhỡ',
  'proactive.mobile.category.parcel': 'Giao bưu kiện',
  'proactive.mobile.category.appointment': 'Lịch hẹn',
  'proactive.mobile.category.message': 'Tin nhắn quan trọng',
  'proactive.mobile.category.other': 'Trạng thái khác',
  'proactive.mobile.settingsLoadFailed': 'Không thể tải cài đặt cảnh báo di động',
  'proactive.mobile.settingsSaveFailed': 'Không thể lưu cài đặt cảnh báo di động',
  'proactive.mobile.settingsSaved': 'Đã lưu cài đặt cảnh báo di động',
  'proactive.mobile.settingsInvalid': 'Hãy chọn ít nhất một danh mục cảnh báo hợp lệ',
  'proactive.mobile.type.notification.state_changed': 'Thay đổi trạng thái thông báo',
  'proactive.mobile.type.location.transition': 'Chuyển tiếp vị trí',
  'proactive.mobile.stage.received': 'Đã tiếp nhận',
  'proactive.mobile.stage.prefiltered': 'Đã lọc sơ bộ',
  'proactive.mobile.stage.classified': 'Đã phân loại, không nhắc',
  'proactive.mobile.stage.ignored': 'Đã bỏ qua',
  'proactive.mobile.stage.converted': 'Đã tạo nhắc nhở',
  'proactive.mobile.stage.error': 'Lỗi phân loại hoặc chuyển đổi',
  'proactive.eventType.mobile_alert': 'Nhắc nhở di động',
  'proactive.habits': 'Thói quen',
  'proactive.silentUntil': 'Đã bật im lặng hôm nay. Dự kiến khôi phục: {time}',
  'proactive.mode': 'Mức độ chủ động',
  'proactive.mode.conservative': 'Thận trọng',
  'proactive.mode.active': 'Chủ động',
  'proactive.mode.aggressive': 'Tích cực',
  'proactive.modeHelp.conservative': 'Chỉ thông báo quan trọng nhất, tối đa 1 mỗi ngày.',
  'proactive.modeHelp.active': 'Cân bằng mức quan trọng và tần suất, tối đa 5 mỗi ngày.',
  'proactive.modeHelp.aggressive': 'Cung cấp cập nhật kịp thời không giới hạn tổng số lần chủ động thông thường mỗi ngày.',
  'proactive.dailyLimit': 'Giới hạn hằng ngày',
  'proactive.dailyLimitHelp': 'Tối đa {max} ở chế độ này',
  'proactive.unlimited': 'Không giới hạn',
  'proactive.unlimitedHelp': 'Chỉ bỏ tổng hạn mức ngày; giờ yên lặng và quy tắc chủ đề vẫn áp dụng',
  'proactive.quietHours': 'Giờ yên lặng',
  'proactive.quietStart': 'Giờ bắt đầu',
  'proactive.quietEnd': 'Giờ kết thúc',
  'proactive.clear': 'Xóa',
  'proactive.allowedTopics': 'Chủ đề cho phép',
  'proactive.allowedTopicsHelp': 'Để trống để cho phép mọi chủ đề không bị chặn.',
  'proactive.blockedTopics': 'Chủ đề bị chặn',
  'proactive.save': 'Lưu cài đặt',
  'proactive.silentToday': 'Im lặng hôm nay',
  'proactive.topic': 'Chủ đề',
  'proactive.eventType': 'Loại sự kiện',
  'proactive.deliveryStatus': 'Trạng thái gửi',
  'proactive.filter': 'Lọc',
  'proactive.createdAt': 'Thời gian tạo',
  'proactive.reason': 'Lý do kích hoạt',
  'proactive.outcome': 'Kết quả',
  'proactive.noEvents': 'Không có sự kiện',
  'proactive.habitType': 'Loại thói quen',
  'proactive.habitKey': 'Mã thói quen',
  'proactive.evidenceCount': 'Bằng chứng',
  'proactive.habitStatus': 'Trạng thái',
  'proactive.lastSeenAt': 'Quan sát gần nhất',
  'proactive.operation': 'Thao tác',
  'proactive.delete': 'Xóa',
  'proactive.noHabits': 'Không có thói quen',
  'proactive.loadPreferenceFailed': 'Không thể tải cài đặt trợ lý chủ động',
  'proactive.saveSuccess': 'Đã lưu cài đặt trợ lý chủ động',
  'proactive.saveFailed': 'Không thể lưu cài đặt trợ lý chủ động',
  'proactive.validation.mode': 'Chọn mức độ chủ động hợp lệ',
  'proactive.validation.daily_limit': 'Giới hạn hằng ngày nằm ngoài phạm vi của chế độ',
  'proactive.validation.quiet_window': 'Cần đặt hai thời điểm yên lặng khác nhau',
  'proactive.validation.topics': 'Chủ đề cho phép và bị chặn không được trùng nhau',
  'proactive.silentTodayConfirm': 'Thiết bị sẽ ngừng thông báo chủ động trong thời gian còn lại hôm nay. Tiếp tục?',
  'proactive.silentTodaySuccess': 'Đã bật im lặng hôm nay',
  'proactive.silentTodayFailed': 'Không thể bật im lặng hôm nay',
  'proactive.loadEventsFailed': 'Không thể tải nhật ký sự kiện',
  'proactive.loadHabitsFailed': 'Không thể tải thói quen',
  'proactive.deleteHabitConfirm': 'Xóa bản ghi thói quen này?',
  'proactive.deleteHabitSuccess': 'Đã xóa bản ghi thói quen',
  'proactive.deleteHabitFailed': 'Không thể xóa bản ghi thói quen',
  'proactive.topic.reminder': 'Nhắc nhở',
  'proactive.topic.calendar': 'Lịch',
  'proactive.topic.weather': 'Thời tiết',
  'proactive.topic.music': 'Âm nhạc',
  'proactive.topic.health': 'Sức khỏe',
  'proactive.topic.habit': 'Thói quen',
  'proactive.topic.system': 'Hệ thống',
  'proactive.eventType.reminder': 'Nhắc nhở',
  'proactive.eventType.due_soon': 'Sắp đến hạn',
  'proactive.eventType.schedule_change': 'Thay đổi lịch',
  'proactive.eventType.weather_alert': 'Cảnh báo thời tiết',
  'proactive.eventType.music_status': 'Trạng thái nhạc',
  ...
  'proactive.deliveryStatus.dismissed': 'Đã bỏ qua',
  'proactive.outcome.none': 'Không có',
  'proactive.outcome.acknowledged': 'Đã xác nhận',
  'proactive.outcome.completed': 'Đã hoàn thành',
  'proactive.outcome.dismissed': 'Đã bỏ qua',
  'proactive.outcome.failed': 'Thất bại',
  'proactive.habitType.time_pattern': 'Quy luật thời gian',
  'proactive.habitType.repeated_action': 'Hành động lặp lại',
  'proactive.habitType.content_preference': 'Sở thích nội dung',
  'proactive.habitStatus.observed': 'Đang quan sát',
  'proactive.habitStatus.suggested': 'Đã đề xuất',
  'proactive.habitStatus.accepted': 'Đã chấp nhận',
  'proactive.habitStatus.dismissed': 'Đã bỏ qua',
}
