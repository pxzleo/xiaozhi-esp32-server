export default {
  ...
  'device.displayName': 'Anzeigename',
  'device.displayNameInvalid': 'Der Anzeigename ist erforderlich und darf höchstens 64 Zeichen lang sein',
  'device.displayNameSaved': 'Anzeigename gespeichert',
  'device.displayNameSaveFailed': 'Anzeigename konnte nicht gespeichert werden',
  'terminalSensing.title': 'Endgeräte und Sensorik',
  ...
  'agentSnapshot.plugin.SYSTEM_PLUGIN_NETEASE_MUSIC': 'NetEase-Cloud-Music-Player',
  ...
  'functionDialog.neteaseLoginStatus': 'NetEase-Cloud-Konto',
  'functionDialog.neteaseLoggedIn': 'Angemeldet',
  'functionDialog.neteaseAnonymous': 'Nicht angemeldet; nur öffentliche kostenlose Titel',
  'functionDialog.neteaseWaitingScan': 'Warte auf QR-Bestätigung',
  'functionDialog.neteaseQrExpired': 'QR-Code abgelaufen',
  'functionDialog.neteaseScanLogin': 'Per QR-Code anmelden',
  'functionDialog.neteaseLogout': 'Anmeldung löschen',
  'functionDialog.neteaseQrAlt': 'NetEase-Cloud-Music-Anmelde-QR-Code',
  'functionDialog.neteaseLoginTip': 'Nach der Anmeldung können Wiedergabelisten, tägliche Empfehlungen, Personal FM und im Konto enthaltene VIP-Titel per Sprache abgespielt werden. Anmeldedaten werden nicht angezeigt.',
  'functionDialog.neteaseLoginSuccess': 'NetEase-Cloud-Music-Anmeldung erfolgreich. Bitte Konfiguration speichern.',
  'functionDialog.neteaseLoginFailed': 'NetEase-Cloud-Music-Anmeldung fehlgeschlagen',
  'functionDialog.neteaseLogoutSuccess': 'NetEase-Cloud-Music-Anmeldung gelöscht',
  ...
  'proactive.title': 'Proaktiver Assistent',
  'proactive.routing.title': 'Empfangsgeräte',
  'proactive.routing.introTitle': 'Proaktive Aktionen nach Ort verteilen',
  'proactive.routing.introHelp': 'Erinnerungen, Wecker und proaktive Gespräche gehen standardmäßig an die ausgewählten Geräte. Für einen erkannten Ort gelten dessen Empfänger.',
  'proactive.routing.futureOnly': 'Gespeicherte Änderungen gelten nur für neue Ereignisse. Bestehende Ereignisse werden nicht erneut gesendet oder geändert.',
  'proactive.routing.defaults': 'Standardempfänger',
  'proactive.routing.defaultsHelp': 'Wird verwendet, wenn der Ort unbekannt, veraltet oder ohne Regel ist. Standardmäßig sind alle Geräte des Kontos ausgewählt.',
  'proactive.routing.selectAll': 'Alle auswählen',
  'proactive.routing.clearAll': 'Alle abwählen',
  'proactive.routing.noDevices': 'Für dieses Konto sind keine Geräte verfügbar.',
  'proactive.routing.emptyDefaultsHelp': 'Ohne Standardempfänger werden bei unbekanntem oder veraltetem Ort keine proaktiven Aktionen zugestellt.',
  'proactive.routing.places': 'Empfangsregeln nach Ort',
  'proactive.routing.placesHelp': 'Orte stammen aus Geofences der mobilen App. Jedem Ort können mehrere Empfänger zugewiesen werden.',
  'proactive.routing.activePlace': 'Aktuell gültiger Ort',
  'proactive.routing.noPlaces': 'Noch keine Orte verfügbar. Erstellen Sie zuerst einen Ort in der mobilen App und melden Sie einmal den Standort.',
  'proactive.routing.chooseDevices': 'Empfangsgeräte auswählen',
  'proactive.routing.locationDoesNotNotify': 'Orte wählen nur Empfangsgeräte aus. Das Betreten oder Verlassen löst selbst keine proaktive Meldung aus.',
  'proactive.routing.locationAuthority': 'Telefon für Standortbestimmung',
  'proactive.routing.locationAuthorityHelp': 'Bei mehreren Telefonen bestimmt nur dieses den Standort. Ohne Auswahl oder nach 12 Stunden gelten Standardgeräte. Nur neue Ereignisse.',
  'proactive.routing.noLocationAuthority': 'Nicht festgelegt',
  'proactive.routing.fixedDevices': 'Standorte fester Geräte',
  'proactive.routing.fixedDevicesHelp': 'Kennzeichnen Sie den Ort fester Geräte wie Lautsprecher, damit die Ortsregeln leichter zu pflegen sind.',
  'proactive.routing.noFixedPlace': 'Kein fester Ort',
  'proactive.routing.save': 'Empfänger speichern',
  'proactive.routing.loadFailed': 'Empfängereinstellungen konnten nicht geladen werden',
  'proactive.routing.saveFailed': 'Empfängereinstellungen konnten nicht gespeichert werden. Aktualisieren Sie die Seite und versuchen Sie es erneut.',
  'proactive.routing.saveSuccess': 'Empfängereinstellungen gespeichert',
  'proactive.routing.terminalType.mobile': 'Mobilgerät',
  'proactive.routing.terminalType.speaker': 'Lautsprecher',
  'proactive.routing.validation.devices': 'Ungültige Geräteauswahl. Aktualisieren Sie die Seite und versuchen Sie es erneut.',
  'proactive.routing.validation.places': 'Ungültige Ortseinstellungen. Aktualisieren Sie die Seite und versuchen Sie es erneut.',
  'proactive.routing.validation.version': 'Ungültige Einstellungsversion. Aktualisieren Sie die Seite und versuchen Sie es erneut.',
  'paramManagement.classifierAvailable': 'Available',
  'paramManagement.classifierDescription': 'Select a dedicated global LLM for major-news monitoring. The device agent model is never used.',
  'paramManagement.classifierLoadFailed': 'Failed to load the classifier setting',
  'paramManagement.classifierModelsFailed': 'Failed to load LLM models',
  'paramManagement.classifierNoFallback': 'News reports an error when this model is unavailable and never falls back to the device model; weather runs independently.',
  'paramManagement.classifierPlaceholder': 'Select a dedicated LLM',
  'paramManagement.classifierRequired': 'Select a valid LLM model',
  'paramManagement.classifierSave': 'Save model',
  'paramManagement.classifierSaveFailed': 'Failed to save the classifier',
  'paramManagement.classifierSaveSuccess': 'Classifier saved',
  'paramManagement.classifierTest': 'Test connection',
  'paramManagement.classifierTestFailed': 'Failed to test the classifier',
  'paramManagement.classifierTestSuccess': 'Classifier connection is available',
  'paramManagement.classifierTestUnavailable': 'Classifier is unavailable',
  'paramManagement.classifierTitle': 'External news classifier',
  'paramManagement.classifierUnavailable': 'Unavailable',
  'proactive.externalMonitors': 'External monitoring',
  'paramManagement.externalMonitoringTitle': 'External monitoring server gate',
  'paramManagement.externalMonitoringDescription': 'Controls whether background weather and major-news monitoring runs. It is off by default.',
  'paramManagement.externalMonitoringEnabled': 'Globally enabled',
  'paramManagement.externalMonitoringLoading': 'Loading',
  'paramManagement.externalMonitoringUnknown': 'Status unknown',
  'paramManagement.externalMonitoringDisabled': 'Globally disabled',
  'paramManagement.externalMonitoringEnable': 'Enable global monitoring',
  'paramManagement.externalMonitoringDisable': 'Disable global monitoring',
  'paramManagement.externalMonitoringSave': 'Save server gate',
  'paramManagement.externalMonitoringNoDeviceMutation': 'Disabling pauses server monitoring and external-event claims without changing any device weather or news setting.',
  'paramManagement.externalMonitoringLoadFailed': 'Failed to load the external monitoring server gate',
  'paramManagement.externalMonitoringSaveFailed': 'Failed to save the external monitoring server gate',
  'paramManagement.externalMonitoringSaveSuccess': 'External monitoring server gate saved',
  'proactive.monitor.globalStatus': 'Server gate',
  'proactive.monitor.globalStatus.enabled': 'Globally enabled',
  'proactive.monitor.globalStatus.disabled': 'Globally disabled',
  'proactive.monitor.globalStatus.unknown': 'Status unknown',
  'proactive.monitor.globalStatusHelp': 'This only shows the server gate. Disabling it does not change this device\'s weather or news settings.',
  'proactive.monitor.advanced': 'Advanced',
  'proactive.monitor.categories': 'Categories',
  'proactive.monitor.classifierAvailable': 'Classifier Available',
  'proactive.monitor.classifierChecking': 'Checking',
  'proactive.monitor.classifierIndependent': 'News uses only the dedicated global classifier and never falls back to the device model.',
  'proactive.monitor.classifierStatus': 'Classifier Status',
  'proactive.monitor.classifierUnavailable': 'Missing or unavailable',
  'proactive.monitor.classifierUnknown': 'Not authorized or status unknown',
  'proactive.monitor.common': 'Common settings',
  'proactive.monitor.confidence': 'Confidence',
  'proactive.monitor.emptyMeansDefault': 'Leave empty to use server defaults.',
  'proactive.monitor.emptySourcesHelp': 'Leave empty to inherit NewsNow sources, or use server defaults when absent.',
  'proactive.monitor.forecastHours': 'Forecast window (hours)',
  'proactive.monitor.hazardTypes': 'Hazard Types',
  'proactive.monitor.highTemp': 'High temperature (°C)',
  'proactive.monitor.interval': 'Interval',
  'proactive.monitor.lastError': 'Last Error',
  'proactive.monitor.lastProbe': 'Last Probe',
  'proactive.monitor.lastSuccess': 'Last Success',
  'proactive.monitor.loadFailed': 'Load Failed',
  'proactive.monitor.location': 'Inherited location',
  'proactive.monitor.locationConfigError': 'Location configuration error',
  'proactive.monitor.locationError.agent_not_bound': 'The device has no bound agent',
  'proactive.monitor.locationError.weather_plugin_not_configured': 'The agent has no get_weather plugin',
  'proactive.monitor.locationError.weather_config_ambiguous': 'The agent has ambiguous weather plugin settings',
  'proactive.monitor.locationError.weather_config_invalid': 'The weather plugin setting is invalid',
  'proactive.monitor.locationError.default_location_missing': 'The weather plugin has no default_location',
  'proactive.monitor.locationError.default_location_invalid': 'The weather plugin default_location is invalid',
  'proactive.monitor.locationInherited': 'Inherited from the agent weather location; no fallback location is guessed.',
  'proactive.monitor.locationMissing': 'No inherited location',
  'proactive.monitor.locationMissingHelp': 'Configure and save the agent weather location; the authoritative inherited location then appears here.',
  'proactive.monitor.lowTemp': 'Low temperature (°C)',
  'proactive.monitor.minutes': 'Minutes',
  'proactive.monitor.newsAdvanced': 'Advanced news settings',
  'proactive.monitor.newsCooldown': 'News topic cooldown',
  'proactive.monitor.newsEnabled': 'Major-news monitoring',
  'proactive.monitor.nextCheck': 'Next Check',
  'proactive.monitor.officialSeverity': 'Minimum official alert level',
  'proactive.monitor.precipProbability': 'Precipitation probability (%)',
  'proactive.monitor.preset': 'Resource profile',
  'proactive.monitor.preset.balanced': 'Balanced',
  'proactive.monitor.preset.custom': 'Custom intervals',
  'proactive.monitor.preset.economical': 'Economical',
  'proactive.monitor.preset.timely': 'Timely',
  'proactive.monitor.save': 'Save',
  'proactive.monitor.saveFailed': 'Save Failed',
  'proactive.monitor.saveSuccess': 'Save Success',
  'proactive.monitor.sources': 'Sources',
  'proactive.monitor.sourcesPlaceholder': 'Type a source and press Enter',
  'proactive.monitor.status': 'Status',
  'proactive.monitor.statusDisabled': 'Disabled',
  'proactive.monitor.statusError': 'Error',
  'proactive.monitor.statusRunning': 'Running',
  'proactive.monitor.statusWaiting': 'Waiting for first run',
  'proactive.monitor.tempDrop': '24-hour temperature drop (°C)',
  'proactive.monitor.weatherAdvanced': 'Advanced weather settings',
  'proactive.monitor.weatherEnabled': 'Weather monitoring',
  'proactive.monitor.windSpeed': 'Wind speed (km/h)',
  'proactive.monitor.hazard.rainstorm': 'Rainstorm',
  'proactive.monitor.hazard.thunderstorm': 'Thunderstorm',
  'proactive.monitor.hazard.hail': 'Hail',
  'proactive.monitor.hazard.blizzard': 'Blizzard',
  'proactive.monitor.hazard.high_wind': 'High wind',
  'proactive.monitor.hazard.high_temperature': 'High temperature',
  'proactive.monitor.hazard.low_temperature': 'Low temperature',
  'proactive.monitor.hazard.temperature_drop': 'Temperature drop',
  'proactive.monitor.severity.minor': 'Minor',
  'proactive.monitor.severity.moderate': 'Moderate',
  'proactive.monitor.severity.severe': 'Severe',
  'proactive.monitor.severity.extreme': 'Extreme',
  'proactive.monitor.category.public_safety': 'Public safety',
  'proactive.monitor.category.natural_disaster': 'Natural disaster',
  'proactive.monitor.category.major_policy': 'Major policy',
  'proactive.monitor.category.international_conflict': 'International conflict',
  'proactive.monitor.category.major_economy': 'Major economy',
  'proactive.monitor.category.major_technology': 'Major technology',
  'proactive.monitor.validation.enabled': 'Invalid monitor switch',
  'proactive.monitor.validation.interval_minutes': 'Interval must be an integer from 5 to 1440 minutes',
  'proactive.monitor.validation.weather_config': 'Invalid weather configuration',
  'proactive.monitor.validation.weather_thresholds': 'Invalid weather thresholds; low temperature must be below high temperature',
  'proactive.monitor.validation.news_config': 'Invalid news configuration',
  'proactive.monitor.validation.news_thresholds': 'Invalid news confidence or cooldown',
  'proactive.monitor.weather': 'Weather monitor',
  'proactive.monitor.news': 'News monitor',
  'proactive.topic.news': 'News',
  'proactive.eventType.news_alert': 'News alert',
  'proactive.settings': 'Einstellungen',
  'proactive.events': 'Ereignisprotokoll',
  'proactive.mobileEvents': 'Mobil erfasste Ereignisse',
  'proactive.mobile.type': 'Erfassungstyp',
  'proactive.mobile.stage': 'Verarbeitungsstufe',
  'proactive.mobile.from': 'Startzeit',
  'proactive.mobile.to': 'Endzeit',
  'proactive.mobile.noEvents': 'Keine mobil erfassten Ereignisse',
  'proactive.mobile.instance': 'Mobilinstanz',
  'proactive.mobile.source': 'Quell-App',
  'proactive.mobile.summary': 'Bereinigte Zusammenfassung',
  'proactive.mobile.spokenSummary': 'Kontrollierte Sprachausgabe',
  'proactive.mobile.reasonCode': 'Kontrollierter Grund',
  'proactive.mobile.proactiveEvent': 'Verknüpftes proaktives Ereignis',
  'proactive.mobile.occurredAt': 'Zeitpunkt',
  'proactive.mobile.category': 'Kategorie',
  'proactive.mobile.confidence': 'Konfidenz',
  'proactive.mobile.instanceUnavailable': 'Das ausgewählte Gerät ist keine verknüpfte Mobilinstanz',
  'proactive.mobile.chooseSettingsPhone': 'Telefon für Sensoreinstellungen auswählen',
  'proactive.mobile.loadFailed': 'Mobil erfasste Ereignisse konnten nicht geladen werden',
  'proactive.mobile.sensitivity': 'Hinweisempfindlichkeit',
  'proactive.mobile.sensitivity.conservative': 'Zurückhaltend',
  'proactive.mobile.sensitivity.balanced': 'Ausgewogen',
  'proactive.mobile.sensitivity.timely': 'Zeitnah',
  'proactive.mobile.categories': 'Hinweisumfang',
  'proactive.mobile.categoriesHelp': 'Lieferung, Sicherheit, verpasste Anrufe und Termine nutzen feste Regeln; andere Inhalte werden vom Modell geprüft.',
  'proactive.mobile.category.security': 'Kontosicherheit',
  'proactive.mobile.category.call': 'Verpasste Anrufe',
  'proactive.mobile.category.parcel': 'Paketzustellung',
  'proactive.mobile.category.appointment': 'Termine',
  'proactive.mobile.category.message': 'Wichtige Nachrichten',
  'proactive.mobile.category.other': 'Andere Statusmeldungen',
  'proactive.mobile.settingsLoadFailed': 'Einstellungen für mobile Hinweise konnten nicht geladen werden',
  'proactive.mobile.settingsSaveFailed': 'Einstellungen für mobile Hinweise konnten nicht gespeichert werden',
  'proactive.mobile.settingsSaved': 'Einstellungen für mobile Hinweise gespeichert',
  'proactive.mobile.settingsInvalid': 'Wählen Sie mindestens eine gültige Hinweiskategorie',
  'proactive.mobile.type.notification.state_changed': 'Benachrichtigungsstatus geändert',
  'proactive.mobile.type.location.transition': 'Standortübergang',
  'proactive.mobile.stage.received': 'Empfangen',
  'proactive.mobile.stage.prefiltered': 'Vorab gefiltert',
  'proactive.mobile.stage.classified': 'Klassifiziert, ohne Hinweis',
  'proactive.mobile.stage.ignored': 'Ignoriert',
  'proactive.mobile.stage.converted': 'Hinweis erstellt',
  'proactive.mobile.stage.error': 'Fehler bei Klassifizierung oder Umwandlung',
  'proactive.eventType.mobile_alert': 'Mobiler Hinweis',
  'proactive.habits': 'Gewohnheiten',
  'proactive.silentUntil': 'Heute stumm ist aktiv. Voraussichtliche Wiederherstellung: {time}',
  'proactive.mode': 'Aktivitätsstufe',
  'proactive.mode.conservative': 'Zurückhaltend',
  'proactive.mode.active': 'Aktiv',
  'proactive.mode.aggressive': 'Sehr aktiv',
  'proactive.modeHelp.conservative': 'Nur die wichtigsten Hinweise, höchstens 1 pro Tag.',
  'proactive.modeHelp.active': 'Ausgewogene Wichtigkeit und Häufigkeit, höchstens 5 pro Tag.',
  'proactive.modeHelp.aggressive': 'Zeitnahe Hinweise ohne tägliches Gesamtlimit für normale proaktive Ausgaben.',
  'proactive.dailyLimit': 'Tageslimit',
  'proactive.dailyLimitHelp': 'In diesem Modus höchstens {max}',
  'proactive.unlimited': 'Unbegrenzt',
  'proactive.unlimitedHelp': 'Nur das Tageslimit entfällt; Ruhezeiten und Themenregeln bleiben aktiv',
  'proactive.quietHours': 'Ruhezeiten',
  'proactive.quietStart': 'Startzeit',
  'proactive.quietEnd': 'Endzeit',
  'proactive.clear': 'Löschen',
  'proactive.allowedTopics': 'Erlaubte Themen',
  'proactive.allowedTopicsHelp': 'Leer lassen, um alle nicht gesperrten Themen zu erlauben.',
  'proactive.blockedTopics': 'Gesperrte Themen',
  'proactive.save': 'Einstellungen speichern',
  'proactive.silentToday': 'Heute stumm',
  'proactive.topic': 'Thema',
  'proactive.eventType': 'Ereignistyp',
  'proactive.deliveryStatus': 'Zustellstatus',
  'proactive.filter': 'Filtern',
  'proactive.createdAt': 'Erstellt',
  'proactive.reason': 'Auslösegrund',
  'proactive.outcome': 'Ergebnis',
  'proactive.noEvents': 'Keine Ereignisse',
  'proactive.habitType': 'Gewohnheitstyp',
  'proactive.habitKey': 'Gewohnheitsschlüssel',
  'proactive.evidenceCount': 'Belege',
  'proactive.habitStatus': 'Status',
  'proactive.lastSeenAt': 'Zuletzt beobachtet',
  'proactive.operation': 'Aktionen',
  'proactive.delete': 'Löschen',
  'proactive.noHabits': 'Keine Gewohnheiten',
  'proactive.loadPreferenceFailed': 'Assistenteneinstellungen konnten nicht geladen werden',
  'proactive.saveSuccess': 'Assistenteneinstellungen gespeichert',
  'proactive.saveFailed': 'Assistenteneinstellungen konnten nicht gespeichert werden',
  'proactive.validation.mode': 'Gültige Aktivitätsstufe auswählen',
  'proactive.validation.daily_limit': 'Das Tageslimit liegt außerhalb des Bereichs für diesen Modus',
  'proactive.validation.quiet_window': 'Beide unterschiedlichen Ruhezeiten müssen festgelegt werden',
  'proactive.validation.topics': 'Erlaubte und gesperrte Themen dürfen sich nicht überschneiden',
  'proactive.silentTodayConfirm': 'Das Gerät sendet heute keine proaktiven Hinweise mehr. Fortfahren?',
  'proactive.silentTodaySuccess': 'Heute stumm wurde aktiviert',
  'proactive.silentTodayFailed': 'Heute stumm konnte nicht aktiviert werden',
  'proactive.loadEventsFailed': 'Ereignisprotokoll konnte nicht geladen werden',
  'proactive.loadHabitsFailed': 'Gewohnheiten konnten nicht geladen werden',
  'proactive.deleteHabitConfirm': 'Diesen Gewohnheitseintrag löschen?',
  'proactive.deleteHabitSuccess': 'Gewohnheitseintrag gelöscht',
  'proactive.deleteHabitFailed': 'Gewohnheitseintrag konnte nicht gelöscht werden',
  'proactive.topic.reminder': 'Erinnerung',
  'proactive.topic.calendar': 'Kalender',
  'proactive.topic.weather': 'Wetter',
  'proactive.topic.music': 'Musik',
  'proactive.topic.health': 'Gesundheit',
  'proactive.topic.habit': 'Gewohnheit',
  'proactive.topic.system': 'System',
  'proactive.eventType.reminder': 'Erinnerung',
  'proactive.eventType.due_soon': 'Bald fällig',
  'proactive.eventType.schedule_change': 'Terminänderung',
  'proactive.eventType.weather_alert': 'Wetterwarnung',
  'proactive.eventType.music_status': 'Musikstatus',
  'proactive.eventType.habit_suggestion': 'Gewohnheitsvorschlag',
  'proactive.eventType.system': 'System',
  'proactive.deliveryStatus.pending': 'Ausstehend',
  'proactive.deliveryStatus.claimed': 'Beansprucht',
  'proactive.deliveryStatus.delivered': 'Zugestellt',
  'proactive.deliveryStatus.failed': 'Fehlgeschlagen',
  'proactive.deliveryStatus.expired': 'Abgelaufen',
  'proactive.deliveryStatus.dismissed': 'Verworfen',
  'proactive.outcome.none': 'Keines',
  'proactive.outcome.acknowledged': 'Bestätigt',
  'proactive.outcome.completed': 'Abgeschlossen',
  'proactive.outcome.dismissed': 'Verworfen',
  'proactive.outcome.failed': 'Fehlgeschlagen',
  'proactive.habitType.time_pattern': 'Zeitmuster',
  'proactive.habitType.repeated_action': 'Wiederholte Aktion',
  'proactive.habitType.content_preference': 'Inhaltspräferenz',
  'proactive.habitStatus.observed': 'Beobachtet',
  'proactive.habitStatus.suggested': 'Vorgeschlagen',
  'proactive.habitStatus.accepted': 'Akzeptiert',
  'proactive.habitStatus.dismissed': 'Verworfen',
}
