export default {
  ...
  'device.remark': '備註',
  'device.displayName': '顯示名稱',
  'device.displayNameInvalid': '顯示名稱不可為空且最多 64 個字元',
  'device.displayNameSaved': '顯示名稱已儲存',
  'device.displayNameSaveFailed': '顯示名稱儲存失敗',
  'terminalSensing.title': '終端與感知',
  ...
  'agentSnapshot.plugin.SYSTEM_PLUGIN_NETEASE_MUSIC': '網易雲音樂播放',
  ...
  'functionDialog.neteaseLoginStatus': '網易雲帳號',
  'functionDialog.neteaseLoggedIn': '已登入',
  'functionDialog.neteaseAnonymous': '未登入，僅播放公開免費歌曲',
  'functionDialog.neteaseWaitingScan': '等待掃碼確認',
  'functionDialog.neteaseQrExpired': '二維碼已過期',
  'functionDialog.neteaseScanLogin': '掃碼登入網易雲',
  'functionDialog.neteaseLogout': '清除登入',
  'functionDialog.neteaseQrAlt': '網易雲音樂登入二維碼',
  'functionDialog.neteaseLoginTip': '登入後可透過語音播放帳號歌單、每日推薦、私人FM及帳號擁有權益的VIP歌曲。登入憑據不會顯示在頁面中。',
  'functionDialog.neteaseLoginSuccess': '網易雲音樂登入成功，請儲存功能設定',
  'functionDialog.neteaseLoginFailed': '網易雲音樂登入失敗',
  'functionDialog.neteaseLogoutSuccess': '已清除網易雲音樂登入',
  ...
  'proactive.title': '主動助理',
  'proactive.routing.title': '接收終端',
  'proactive.routing.introTitle': '依地點選擇主動行為的接收終端',
  'proactive.routing.introHelp': '提醒、鬧鐘與主動對話預設傳送到所選終端；識別到地點時使用該地點的終端設定。',
  'proactive.routing.futureOnly': '儲存後只影響新產生的事件，不會補發或變更既有事件。',
  'proactive.routing.defaults': '預設接收終端',
  'proactive.routing.defaultsHelp': '位置未知、已過期或沒有地點規則時使用。預設選擇帳號下的全部終端。',
  'proactive.routing.selectAll': '全選',
  'proactive.routing.clearAll': '全部取消',
  'proactive.routing.noDevices': '帳號下沒有可用終端。',
  'proactive.routing.emptyDefaultsHelp': '未選擇預設終端時，位置未知或過期期間不會投遞主動行為。',
  'proactive.routing.places': '地點接收規則',
  'proactive.routing.placesHelp': '地點來自手機端建立並上報的圍欄；每個地點可以選擇多個接收終端。',
  'proactive.routing.activePlace': '目前有效地點',
  'proactive.routing.noPlaces': '尚無可設定的地點，請先在手機端建立地點並完成一次位置上報。',
  'proactive.routing.chooseDevices': '選擇接收終端',
  'proactive.routing.locationDoesNotNotify': '地點只用於選擇投遞終端，進入或離開地點本身不會觸發主動提醒。',
  'proactive.routing.locationAuthority': '位置判定手機',
  'proactive.routing.locationAuthorityHelp': '多部手機時只採用這一部的位置；未指定或超過 12 小時未更新時使用預設終端。只影響新事件。',
  'proactive.routing.noLocationAuthority': '暫不指定',
  'proactive.routing.fixedDevices': '固定終端所屬地點',
  'proactive.routing.fixedDevicesHelp': '為音箱等固定終端標記所在位置，方便理解與維護地點路由。',
  'proactive.routing.noFixedPlace': '不指定地點',
  'proactive.routing.save': '儲存接收設定',
  'proactive.routing.loadFailed': '讀取接收終端設定失敗',
  'proactive.routing.saveFailed': '儲存接收終端設定失敗，請重新整理後再試',
  'proactive.routing.saveSuccess': '接收終端設定已儲存',
  'proactive.routing.terminalType.mobile': '手機',
  'proactive.routing.terminalType.speaker': '音箱',
  'proactive.routing.validation.devices': '終端選擇無效，請重新整理後再試',
  'proactive.routing.validation.places': '地點設定無效，請重新整理後再試',
  'proactive.routing.validation.version': '設定版本無效，請重新整理後再試',
  ...
  'proactive.monitor.locationMissingHelp': '請設定並儲存智能體天氣預設城市；儲存後此處直接顯示權威繼承地點。',
  ...
  'proactive.monitor.severity.minor': '輕微',
  'proactive.monitor.severity.moderate': '中等',
  'proactive.monitor.severity.severe': '嚴重',
  'proactive.monitor.severity.extreme': '極端',
  ...
  'proactive.topic.news': '新聞',
  'proactive.eventType.news_alert': '重大新闻',
  'proactive.settings': '設定',
  'proactive.events': '事件稽核',
  'proactive.mobileEvents': '手機感知事件',
  'proactive.mobile.type': '感知類型',
  'proactive.mobile.stage': '處理階段',
  'proactive.mobile.from': '開始時間',
  'proactive.mobile.to': '結束時間',
  'proactive.mobile.noEvents': '暫無手機感知事件',
  'proactive.mobile.instance': '手機實例',
  'proactive.mobile.source': '來源應用',
  'proactive.mobile.summary': '脫敏摘要',
  'proactive.mobile.spokenSummary': '受控播報摘要',
  'proactive.mobile.reasonCode': '受控原因',
  'proactive.mobile.proactiveEvent': '關聯主動事件',
  'proactive.mobile.occurredAt': '發生時間',
  'proactive.mobile.category': '類別',
  'proactive.mobile.confidence': '置信度',
  'proactive.mobile.instanceUnavailable': '目前裝置不是已綁定的手機實例',
  'proactive.mobile.chooseSettingsPhone': '選擇感知設定所屬手機',
  'proactive.mobile.loadFailed': '讀取手機感知事件失敗',
  'proactive.mobile.sensitivity': '提醒敏感度',
  'proactive.mobile.sensitivity.conservative': '保守',
  'proactive.mobile.sensitivity.balanced': '均衡',
  'proactive.mobile.sensitivity.timely': '及時',
  'proactive.mobile.categories': '提醒範圍',
  'proactive.mobile.categoriesHelp': '物流配送、明確安全風險、未接來電和臨近預約使用確定性規則；其他內容再由模型複核。',
  'proactive.mobile.category.security': '帳戶安全',
  'proactive.mobile.category.call': '未接來電',
  'proactive.mobile.category.parcel': '物流包裹',
  'proactive.mobile.category.appointment': '預約行程',
  'proactive.mobile.category.message': '重要消息',
  'proactive.mobile.category.other': '其他狀態',
  'proactive.mobile.settingsLoadFailed': '讀取手機提醒設定失敗',
  'proactive.mobile.settingsSaveFailed': '儲存手機提醒設定失敗',
  'proactive.mobile.settingsSaved': '手機提醒設定已儲存',
  'proactive.mobile.settingsInvalid': '請至少選擇一個有效提醒類別',
  'proactive.mobile.type.notification.state_changed': '通知狀態變化',
  'proactive.mobile.type.location.transition': '地點轉換',
  'proactive.mobile.stage.received': '已接收',
  'proactive.mobile.stage.prefiltered': '已預篩',
  'proactive.mobile.stage.classified': '已分類未提醒',
  'proactive.mobile.stage.ignored': '已忽略',
  'proactive.mobile.stage.converted': '已產生提醒',
  'proactive.mobile.stage.error': '分類或轉換錯誤',
  'proactive.eventType.mobile_alert': '手機提醒',
  'proactive.habits': '習慣',
  'proactive.silentUntil': '今日靜默已開啟，預計恢復時間：{time}',
  'proactive.mode': '主動程度',
  'proactive.mode.conservative': '保守',
  'proactive.mode.active': '主動',
  'proactive.mode.aggressive': '積極',
  'proactive.modeHelp.conservative': '僅傳送最重要的提醒，每日最多 1 則。',
  'proactive.modeHelp.active': '在重要性和頻率之間保持平衡，每日最多 5 則。',
  'proactive.modeHelp.aggressive': '及時提供更多主動資訊，普通主動發言不限每日次數。',
  'proactive.dailyLimit': '每日上限',
  'proactive.dailyLimitHelp': '目前模式最多 {max} 則',
  'proactive.unlimited': '不限次數',
  'proactive.unlimitedHelp': '僅取消每日總額度，其他安靜時段和主題規則仍生效',
  'proactive.quietHours': '安靜時段',
  'proactive.quietStart': '開始時間',
  'proactive.quietEnd': '結束時間',
  'proactive.clear': '清除',
  'proactive.allowedTopics': '允許主題',
  'proactive.allowedTopicsHelp': '未選擇時不額外限制允許主題。',
  'proactive.blockedTopics': '封鎖主題',
  'proactive.save': '儲存設定',
  'proactive.silentToday': '今日靜默',
  'proactive.topic': '主題',
  'proactive.eventType': '事件類型',
  'proactive.deliveryStatus': '傳送狀態',
  'proactive.filter': '篩選',
  'proactive.createdAt': '建立時間',
  'proactive.reason': '觸發原因',
  'proactive.outcome': '結果',
  'proactive.noEvents': '暫無事件記錄',
  'proactive.habitType': '習慣類型',
  'proactive.habitKey': '習慣識別',
  'proactive.evidenceCount': '證據次數',
  'proactive.habitStatus': '狀態',
  'proactive.lastSeenAt': '最近觀察',
  'proactive.operation': '操作',
  'proactive.delete': '刪除',
  'proactive.noHabits': '暫無習慣記錄',
  'proactive.loadPreferenceFailed': '讀取主動助理設定失敗',
  'proactive.saveSuccess': '主動助理設定已儲存',
  'proactive.saveFailed': '儲存主動助理設定失敗',
  'proactive.validation.mode': '請選擇有效的主動程度',
  'proactive.validation.daily_limit': '每日上限不符合目前模式範圍',
  'proactive.validation.quiet_window': '安靜時段需同時設定起止時間，且不能相同',
  'proactive.validation.topics': '允許主題與封鎖主題不能重疊',
  'proactive.silentTodayConfirm': '開啟後，裝置在今天剩餘時間內不再主動通知。是否繼續？',
  'proactive.silentTodaySuccess': '已開啟今日靜默',
  'proactive.silentTodayFailed': '開啟今日靜默失敗',
  'proactive.loadEventsFailed': '讀取事件稽核失敗',
  'proactive.loadHabitsFailed': '讀取習慣失敗',
  'proactive.deleteHabitConfirm': '確定刪除這條習慣記錄嗎？',
  'proactive.deleteHabitSuccess': '習慣記錄已刪除',
  'proactive.deleteHabitFailed': '刪除習慣記錄失敗',
  'proactive.topic.reminder': '提醒',
  'proactive.topic.calendar': '日曆',
  'proactive.topic.weather': '天氣',
  'proactive.topic.music': '音樂',
  'proactive.topic.health': '健康',
  'proactive.topic.habit': '習慣',
  'proactive.topic.system': '系統',
  'proactive.eventType.reminder': '提醒',
  'proactive.eventType.due_soon': '即將到期',
  'proactive.eventType.schedule_change': '日程變更',
  'proactive.eventType.weather_alert': '天氣警報',
  'proactive.eventType.music_status': '音樂狀態',
  ...
  'proactive.outcome.none': '無',
  'proactive.outcome.acknowledged': '已確認',
  'proactive.outcome.completed': '已完成',
  'proactive.outcome.dismissed': '已忽略',
  'proactive.outcome.failed': '失敗',
  'proactive.habitType.time_pattern': '時間規律',
  'proactive.habitType.repeated_action': '重複操作',
  'proactive.habitType.content_preference': '內容偏好',
  'proactive.habitStatus.observed': '觀察中',
  'proactive.habitStatus.suggested': '已建議',
