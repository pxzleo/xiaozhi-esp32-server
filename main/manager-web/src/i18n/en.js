export default {
  ...
  'device.displayNameInvalid': 'Display name is required and must not exceed 64 characters',
  'device.displayNameSaved': 'Display name saved',
  'device.displayNameSaveFailed': 'Failed to save display name',
  'terminalSensing.title': 'Terminals & sensing',
  ...
  'functionDialog.neteaseLoginStatus': 'NetEase Cloud account',
  'functionDialog.neteaseLoggedIn': 'Logged in',
  'functionDialog.neteaseAnonymous': 'Not logged in; public free songs only',
  'functionDialog.neteaseWaitingScan': 'Waiting for QR confirmation',
  'functionDialog.neteaseQrExpired': 'QR code expired',
  'functionDialog.neteaseScanLogin': 'Scan to log in',
  'functionDialog.neteaseLogout': 'Clear login',
  'functionDialog.neteaseQrAlt': 'NetEase Cloud Music login QR code',
  'functionDialog.neteaseLoginTip': 'After login, voice commands can play account playlists, daily recommendations, Personal FM, and VIP songs covered by the account. Credentials are not displayed.',
  'functionDialog.neteaseLoginSuccess': 'NetEase Cloud Music login succeeded. Save the function configuration.',
  'functionDialog.neteaseLoginFailed': 'NetEase Cloud Music login failed',
  'functionDialog.neteaseLogoutSuccess': 'NetEase Cloud Music login cleared',
  ...
  'proactive.title': 'Proactive assistant',
  'proactive.routing.title': 'Recipient devices',
  'proactive.routing.introTitle': 'Route proactive actions by place',
  'proactive.routing.introHelp': 'Reminders, alarms, and proactive conversations go to the selected devices by default. A recognized place uses its own recipients.',
  'proactive.routing.futureOnly': 'Saved changes apply only to new events. Existing events are not resent or changed.',
  'proactive.routing.defaults': 'Default recipients',
  'proactive.routing.defaultsHelp': 'Used when location is unknown, stale, or has no rule. All account devices are selected by default.',
  'proactive.routing.selectAll': 'Select all',
  'proactive.routing.clearAll': 'Clear all',
  'proactive.routing.noDevices': 'No devices are available for this account.',
  'proactive.routing.emptyDefaultsHelp': 'With no default recipients, proactive actions are not delivered while location is unknown or stale.',
  'proactive.routing.places': 'Place recipient rules',
  'proactive.routing.placesHelp': 'Places come from geofences created and reported by the mobile app. Each place can have multiple recipients.',
  'proactive.routing.activePlace': 'Current valid place',
  'proactive.routing.noPlaces': 'No places are available yet. Create one in the mobile app and complete a location report first.',
  'proactive.routing.chooseDevices': 'Choose recipient devices',
  'proactive.routing.locationDoesNotNotify': 'Places only select delivery recipients. Entering or leaving a place does not trigger a proactive alert.',
  'proactive.routing.locationAuthority': 'Location authority phone',
  'proactive.routing.locationAuthorityHelp': 'When several phones are bound, only this phone determines location. Defaults apply when unset or stale for 12 hours. New events only.',
  'proactive.routing.noLocationAuthority': 'Not specified',
  'proactive.routing.fixedDevices': 'Fixed device locations',
  'proactive.routing.fixedDevicesHelp': 'Mark where fixed devices such as speakers are located to make place routing easier to maintain.',
  'proactive.routing.noFixedPlace': 'No fixed place',
  'proactive.routing.save': 'Save recipients',
  'proactive.routing.loadFailed': 'Failed to load recipient settings',
  'proactive.routing.saveFailed': 'Failed to save recipient settings. Refresh and try again.',
  'proactive.routing.saveSuccess': 'Recipient settings saved',
  'proactive.routing.terminalType.mobile': 'Mobile',
  'proactive.routing.terminalType.speaker': 'Speaker',
  'proactive.routing.validation.devices': 'Invalid device selection. Refresh and try again.',
  'proactive.routing.validation.places': 'Invalid place settings. Refresh and try again.',
  'proactive.routing.validation.version': 'Invalid settings version. Refresh and try again.',
  ...
  'proactive.settings': 'Settings',
  'proactive.events': 'Event audit',
  'proactive.mobileEvents': 'Mobile sensing events',
  'proactive.mobile.type': 'Sensing type',
  'proactive.mobile.stage': 'Processing stage',
  'proactive.mobile.from': 'Start time',
  'proactive.mobile.to': 'End time',
  'proactive.mobile.noEvents': 'No mobile sensing events',
  'proactive.mobile.instance': 'Mobile instance',
  'proactive.mobile.source': 'Source app',
  'proactive.mobile.summary': 'Redacted summary',
  'proactive.mobile.spokenSummary': 'Controlled spoken summary',
  'proactive.mobile.reasonCode': 'Controlled reason',
  'proactive.mobile.proactiveEvent': 'Linked proactive event',
  'proactive.mobile.occurredAt': 'Occurred at',
  'proactive.mobile.category': 'Category',
  'proactive.mobile.confidence': 'Confidence',
  'proactive.mobile.instanceUnavailable': 'The selected device is not a bound mobile instance',
  'proactive.mobile.chooseSettingsPhone': 'Choose the phone whose sensing settings to edit',
  'proactive.mobile.loadFailed': 'Failed to load mobile sensing events',
  'proactive.mobile.sensitivity': 'Alert sensitivity',
  'proactive.mobile.sensitivity.conservative': 'Conservative',
  'proactive.mobile.sensitivity.balanced': 'Balanced',
  'proactive.mobile.sensitivity.timely': 'Timely',
  'proactive.mobile.categories': 'Alert scope',
  'proactive.mobile.categoriesHelp': 'Delivery progress, explicit security risks, missed calls and imminent appointments use deterministic rules; other content is model-reviewed.',
  'proactive.mobile.category.security': 'Account security',
  'proactive.mobile.category.call': 'Missed calls',
  'proactive.mobile.category.parcel': 'Parcel delivery',
  'proactive.mobile.category.appointment': 'Appointments',
  'proactive.mobile.category.message': 'Important messages',
  'proactive.mobile.category.other': 'Other status',
  'proactive.mobile.settingsLoadFailed': 'Failed to load mobile alert settings',
  'proactive.mobile.settingsSaveFailed': 'Failed to save mobile alert settings',
  'proactive.mobile.settingsSaved': 'Mobile alert settings saved',
  'proactive.mobile.settingsInvalid': 'Select at least one valid alert category',
  'proactive.mobile.type.notification.state_changed': 'Notification state change',
  'proactive.mobile.type.location.transition': 'Location transition',
  'proactive.mobile.stage.received': 'Received',
  'proactive.mobile.stage.prefiltered': 'Prefiltered',
  'proactive.mobile.stage.classified': 'Classified without alert',
  'proactive.mobile.stage.ignored': 'Ignored',
  'proactive.mobile.stage.converted': 'Alert created',
  'proactive.mobile.stage.error': 'Classification or conversion error',
  'proactive.eventType.mobile_alert': 'Mobile alert',
  'proactive.habits': 'Habits',
  'proactive.silentUntil': 'Silent for today is on. Expected restore time: {time}',
  'proactive.mode': 'Activity level',
  'proactive.mode.conservative': 'Conservative',
  'proactive.mode.active': 'Active',
  'proactive.mode.aggressive': 'Aggressive',
  'proactive.modeHelp.conservative': 'Only the most important notices, up to 1 per day.',
  'proactive.modeHelp.active': 'Balances importance and frequency, up to 5 per day.',
  'proactive.modeHelp.aggressive': 'Provides timely updates with no daily total limit for ordinary proactive speech.',
  'proactive.dailyLimit': 'Daily limit',
  'proactive.dailyLimitHelp': 'Up to {max} in this mode',
  'proactive.unlimited': 'Unlimited',
  'proactive.unlimitedHelp': 'Only the daily total is removed; quiet hours and topic rules still apply',
  'proactive.quietHours': 'Quiet hours',
  'proactive.quietStart': 'Start time',
  'proactive.quietEnd': 'End time',
  'proactive.clear': 'Clear',
  'proactive.allowedTopics': 'Allowed topics',
  'proactive.allowedTopicsHelp': 'Leave empty to allow all topics not blocked below.',
  'proactive.blockedTopics': 'Blocked topics',
  'proactive.save': 'Save settings',
  'proactive.silentToday': 'Silent for today',
  'proactive.topic': 'Topic',
  'proactive.eventType': 'Event type',
  'proactive.deliveryStatus': 'Delivery status',
  'proactive.filter': 'Filter',
  'proactive.createdAt': 'Created',
  'proactive.reason': 'Trigger reason',
  'proactive.outcome': 'Outcome',
  'proactive.noEvents': 'No event records',
  'proactive.habitType': 'Habit type',
  'proactive.habitKey': 'Habit key',
  'proactive.evidenceCount': 'Evidence',
  'proactive.habitStatus': 'Status',
  'proactive.lastSeenAt': 'Last observed',
  'proactive.operation': 'Actions',
  'proactive.delete': 'Delete',
  'proactive.noHabits': 'No habit records',
  'proactive.loadPreferenceFailed': 'Failed to load proactive assistant settings',
  'proactive.saveSuccess': 'Proactive assistant settings saved',
  'proactive.saveFailed': 'Failed to save proactive assistant settings',
  'proactive.validation.mode': 'Select a valid activity level',
  'proactive.validation.daily_limit': 'The daily limit is outside the range for this mode',
  'proactive.validation.quiet_window': 'Set both quiet-hour times and make them different',
  'proactive.validation.topics': 'Allowed and blocked topics cannot overlap',
  'proactive.silentTodayConfirm': 'The device will stop proactive notices for the rest of today. Continue?',
  'proactive.silentTodaySuccess': 'Silent for today enabled',
  'proactive.silentTodayFailed': 'Failed to enable silent for today',
  'proactive.loadEventsFailed': 'Failed to load the event audit',
  'proactive.loadHabitsFailed': 'Failed to load habits',
  'proactive.deleteHabitConfirm': 'Delete this habit record?',
  'proactive.deleteHabitSuccess': 'Habit record deleted',
  'proactive.deleteHabitFailed': 'Failed to delete the habit record',
  'proactive.topic.reminder': 'Reminder',
  'proactive.topic.calendar': 'Calendar',
  'proactive.topic.weather': 'Weather',
  'proactive.topic.music': 'Music',
  'proactive.topic.health': 'Health',
  'proactive.topic.habit': 'Habit',
  'proactive.topic.system': 'System',
  'proactive.eventType.reminder': 'Reminder',
  'proactive.eventType.due_soon': 'Due soon',
  'proactive.eventType.schedule_change': 'Schedule change',
  'proactive.eventType.weather_alert': 'Weather alert',
  'proactive.eventType.music_status': 'Music status',
  'proactive.eventType.habit_suggestion': 'Habit suggestion',
  'proactive.eventType.system': 'System',
  'proactive.deliveryStatus.pending': 'Pending',
  'proactive.deliveryStatus.claimed': 'Claimed',
  'proactive.deliveryStatus.delivered': 'Delivered',
  'proactive.deliveryStatus.failed': 'Failed',
  'proactive.deliveryStatus.expired': 'Expired',
  'proactive.deliveryStatus.dismissed': 'Dismissed',
  'proactive.outcome.none': 'None',
  'proactive.outcome.acknowledged': 'Acknowledged',
  'proactive.outcome.completed': 'Completed',
  'proactive.outcome.dismissed': 'Dismissed',
  'proactive.outcome.failed': 'Failed',
  'proactive.habitType.time_pattern': 'Time pattern',
  'proactive.habitType.repeated_action': 'Repeated action',
  'proactive.habitType.content_preference': 'Content preference',
  'proactive.habitStatus.observed': 'Observed',
  'proactive.habitStatus.suggested': 'Suggested',
  'proactive.habitStatus.accepted': 'Accepted',
  'proactive.habitStatus.dismissed': 'Dismissed',
}
